...
export default function Home() {
  return (
    <>
      <section className="cosmic-grid relative mx-auto grid max-w-6xl gap-10 px-6 pb-20 pt-16 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:pt-24">
        <div>
        ...
        <div className="pulse-blob rounded-3xl border border-white/10 bg-[#0e1318]/80 p-5 shadow-2xl shadow-cyan-950/20">
